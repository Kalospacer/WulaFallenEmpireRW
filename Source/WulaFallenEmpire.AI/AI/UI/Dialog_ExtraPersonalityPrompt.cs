...
namespace WulaFallenEmpire.EventSystem.AI.UI
{
    public class Dialog_ExtraPersonalityPrompt : Window
    {
        ...
        public Dialog_ExtraPersonalityPrompt()
        {
            ...
            _tempPrompt = WulaFallenEmpireAIMod.settings?.extraPersonalityPrompt ?? "";
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            {
                if (WulaFallenEmpireAIMod.settings != null)
                {
                    WulaFallenEmpireAIMod.settings.extraPersonalityPrompt = _tempPrompt;
                    WulaFallenEmpireAIMod.settings.Write();
                }
                this.Close();
            }
