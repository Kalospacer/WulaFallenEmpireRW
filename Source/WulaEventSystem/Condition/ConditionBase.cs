...
namespace WulaFallenEmpire
{
    ...
    public class Condition_VariableEquals : ConditionBase
    {
        ...
        public override bool IsMet(out string reason)
        {
            ...
            {
                Log.Error($"[EventSystem] Condition_VariableEquals: Could not compare '{variable}' and '{compareValueStr}'. Error: {e.Message}");
    ...
    public class Condition_VariableNotEqual : ConditionBase
    {
        ...
        public override bool IsMet(out string reason)
        {
            ...
            {
                Log.Error($"[EventSystem] Condition_VariableNotEqual: Could not compare '{variable}' and '{compareValueStr}'. Error: {e.Message}");
                reason = "Type mismatch or parsing error during comparison.";
                return false;
            }
