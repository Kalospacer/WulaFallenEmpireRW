...
namespace WulaFallenEmpire
{
    public class Effect_CallSkyfaller : EffectBase
    {
        ...
        public override void Execute(Window dialog = null)
        {
            ...
            if (currentMap == null)
            {
                Log.Message("[WulaFallenEmpire] Effect_CallSkyfaller cannot execute without a current map.");
                return;
            }

            if (skyfallerDef == null)
            {
                Log.Message("[WulaFallenEmpire] Effect_CallSkyfaller has a null skyfallerDef.");
                return;
            }
            ...
            {
                Log.Message("[WulaFallenEmpire] Effect_CallSkyfaller could not find a valid drop spot.");
                return;
            }
