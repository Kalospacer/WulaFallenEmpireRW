...
";
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Text.Anchor = TextAnchor.UpperLeft;    // 恢复左对�?
            ...
            // 发送按�?- 使用与Dialog_CustomDisplay相同的自定义按钮样式
            // 保存当前状�?
        ...
        private void DrawChatHistory(Rect rect)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < filteredHistory.Count; i++)
                {
                    ...
                    {
                        Text.Font = GameFont.Small; // 原来�?Medium，改�?Small
                    }
                    else
                    {
                        Text.Font = GameFont.Tiny; // 原来�?Small，改�?Tiny
                    }
                    // 增加padding
